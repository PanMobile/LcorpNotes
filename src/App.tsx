...
import {SunLightThemeLogo} from "./components/logos/shared/SunLightThemeLogo.tsx";
import {MoonDarkThemeLogo} from "./components/logos/shared/MoonDarkThemeLogo.tsx";
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center gap-8">
                            <Link to="/folders" className="flex items-center gap-2 group">
                            ...
                            <div className="hidden md:flex items-center gap-2">
                                <Link to="/folders" className={`px-4 py-2 rounded-xl font-medium transition-all ${
                                    isActive('/folders')
                                ...
                                <Link to="/favorites" className={`px-4 py-2 rounded-xl font-medium transition-all ${
                                    isActive('/favorites')
                                ...
                                <Link to="/profile" className={`px-4 py-2 rounded-xl font-medium transition-all ${
                                    isActive('/profile')
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            {(currentUser || user) && (
                                <div className={`hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg border transition-colors ${
                                    isDarkMode
                            ...
                            {token ? (
                                <button
                                    onClick={logout}
                                    className={`px-4 py-2 rounded-xl font-medium transition-all flex items-center gap-2 group ${
                                        isDarkMode
                                            ? 'text-gray-300 hover:text-red-300 hover:bg-red-500/10'
