            ...
            <div className="w-full">
                ...
                <div className="w-full sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
                        <FooterIcon href="https://t.me/GTOForever" icon={BsTelegram}/>
                        <FooterIcon href="https://wa.me/79649377791" icon={BsWhatsapp}/>
                        <FooterIcon href="https://github.com/PanMobile" icon={BsGithub}/>
                    </div>
                </div>
            </div>
        </Footer>
